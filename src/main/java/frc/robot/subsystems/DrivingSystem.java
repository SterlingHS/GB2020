...
private SpeedControllerGroup speedController-Leftside;
private PWMTalonSRX speedController3;
private PWMTalonSRX speedController4;
private SpeedControllerGroup speedController-Rightside;
...
speedController-Leftside = new SpeedControllerGroup(speedController1, speedController2  );
addChild("Speed Controller- Left side",speedController-Leftside);
...
speedController-Rightside = new SpeedControllerGroup(speedController3, speedController4  );
addChild("Speed Controller - Right side",speedController-Rightside);

        
differentialDrive1 = new DifferentialDrive(speedController-Leftside, speedController-Rightside);
