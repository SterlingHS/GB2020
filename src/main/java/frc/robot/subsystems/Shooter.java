...
public class Shooter extends Subsystem 
{
    ...
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
        ...
        private DigitalInput ball_sensor_shooter = new DigitalInput(RobotMap.SHOOTER_DIO_ID);
        private boolean ball_sensor;
    ...
    {
        return ball_sensor_shooter.get();
    }

    public void shoot_count_out()
    {
       if (get_input() == true && ball_sensor == false)
       {
           ball_sensor = true;
           RobotMap.ball_counter = RobotMap.ball_counter + 1;
       }

        if (get_input() == false && ball_sensor == true)
       {
           ball_sensor = false;
       }
    }
